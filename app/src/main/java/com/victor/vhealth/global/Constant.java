...
public class Constant {
    ...
    public static final String PIC_CHANNEL = "pic_channel";
    ...
    public static class URL {
        ...
        public static final String PIC_BASE = "http://www.tngou.net";
        ...
        public static final String PIC = "/tnfs";
        ...
        public static final String PIC_LIST = PIC + "/api/list";
        public static final String PIC_DETAIL = PIC + "/api/show";
    }
