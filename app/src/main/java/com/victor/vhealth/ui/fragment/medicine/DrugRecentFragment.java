 ...
 */
public class DrugRecentFragment extends ContentBaseFragment {

    private static final int RECENT_GRUG_CLASS = 5;
    ...
    protected LoadingPager.LoadResult initData() {
        mDrugProtocol = new DrugProtocol(RECENT_GRUG_CLASS, Constant.URL.MEDICINE_DRUG);
        try {
