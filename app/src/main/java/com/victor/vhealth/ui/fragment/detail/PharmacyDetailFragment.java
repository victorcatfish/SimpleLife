...
import com.victor.vhealth.protocol.PharmacyDetailProtocol;
 ...
 */
public class PharmacyDetailFragment extends ContentBaseFragment {

    @ViewInject(R.id.tv_pharmacy_detail_name)
    private TextView mTvName;
    @ViewInject(R.id.tv_pharmacy_num)
    private TextView mTvNumber;
    @ViewInject(R.id.tv_pharmacy_tel)
    private TextView mTvTel;
    @ViewInject(R.id.tv_pharmacy_add)
    private TextView mTvAddress;
    @ViewInject(R.id.iv_pharmacy_detail)
    private ImageView mIvImg;
    @ViewInject(R.id.tv_pharmacy_message)
    ...
    protected LoadingPager.LoadResult initData() {
        ...
        PharmacyDetailProtocol protocol = new PharmacyDetailProtocol(Constant.URL.MEDICINE_PHARMACY, mId);
        try {
            mpharmacyInfo = protocol.loadData(0);
            return checkState(mpharmacyInfo);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    protected View initSuccessView() {
        View view = View.inflate(UIUtils.getContext(), R.layout.fragment_pharmacy_detail, null);
        ...
        BitmapHelper.display(mIvImg, Constant.URL.IMG_BASE + mpharmacyInfo.img);
        mTvName.setText(mpharmacyInfo.name);
        mTvNumber.setText("证号："  + mpharmacyInfo.number);
        mTvTel.setText("电话：" + mpharmacyInfo.tel);
        mTvAddress.setText("地址：" + mpharmacyInfo.address);
        if ("".equals(mpharmacyInfo.message)) {
            mTvMessage.setText("暂无简介");
        } else {
            mTvMessage.setText(Html.fromHtml(mpharmacyInfo.message));
    ...
    private int getShortHeight() {
        ...
        view.setMaxLines(4);
        view.setText(Html.fromHtml(mpharmacyInfo.message));
